        ...
        <div className="nk-navbar-wrap">
          <div className={["nk-navbar-logo logo"].join(" ")}>
            ...
            <a href="/" className="logo-link">
              {" "}
              {/* <img className="logo-dark" src="/logo-dark.png" alt="logo" style={{height:"50px",width:"50px"}} />{" "} */}
              {/* <img className="logo-light" src="/logo-white.png" alt="logo"  style={{height:"50px",width:"50px"}}/>{" "} */}
              <h1 style={{marginBottom:"10px"}}>Kovid-19</h1>
            </a>
          </div>
